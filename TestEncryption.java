...
public class TestEncryption {
	...
	public static void main(String[] args) {
		...
		//String path = "D:\\Users\\itt0277\\Desktop\\PGP\\newKeys\\alice-pub.asc";
		String path = "D:\\Users\\itt0277\\Desktop\\PGP\\Lim_Derick-WG.asc";
		String alg = "RSA";
		try{
			 ringPub = PGPKeyReader.readPublicKeyRing(path);
			 System.out.println(ringPub.size());
			 //System.out.println(ringPub.)
			 System.out.println(PGPInit.getKeyExchangeAlgorithm("DSA"));
